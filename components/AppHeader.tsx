...
export default function AppHeader() {
  ...
  const hideUserMenu = !user || !!pathname?.startsWith("/f/");
  ...
  return (
    <header className="sticky top-0 z-50 bg-white/80 backdrop-blur border-b border-neutral-200" dir="rtl">
      <div className="mx-auto max-w-7xl px-6 sm:px-8 w-full h-16 lg:h-20 flex items-center justify-between">
        ...
        {/* תפריט משתמש – מוצג רק כשמחובר ולא ב-/f/* */}
        {!hideUserMenu && (
          <div className="relative" ref={menuRef}>
            ...
            {open && (
              ...
              >
                <button role="menuitem" onClick={doSignOut} className="w-full text-right px-3 py-2 text-sm hover:bg-neutral-50">
                  התנתקות
                </button>
              </div>
            )}
