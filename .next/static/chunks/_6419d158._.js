...
function SignaturePad(param) {
    let { onChange, width = 500, height = 180 } = param;
    _s();
    const ref = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    function handleEnd() {
        var _ref_current;
        const data = (_ref_current = ref.current) === null || _ref_current === void 0 ? void 0 : _ref_current.toDataURL("image/png"); // חייב להחזיר data:image/png;base64,....
        onChange(data || null);
    }
    function clear() {
        var _ref_current;
...
function ParentFormPage() {
    _s();
    const { id: incomingId } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useParams"])();
    ...
    const [resolvedFormId, setResolvedFormId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(incomingId); // נטען/נעדכן אחרי פולבאק
    ...
    const signatureRequired = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ParentFormPage.useMemo[signatureRequired]": ()=>schema.some({
                "ParentFormPage.useMemo[signatureRequired]": (f)=>f.type === "signature" && f.required
            }["ParentFormPage.useMemo[signatureRequired]"])
    }["ParentFormPage.useMemo[signatureRequired]"], [
        schema
    ]);
    ...
    async function onSubmit(e) {
        ...
        try {
            ...
            router.replace("/f/".concat(incomingId, "/thanks"));
        } catch (err) {
            console.error(err);
...
_s(ParentFormPage, "mhXZUB3KQwF3HNM9aGbfdruq4+g=", false, function() {
    return [
