...
"[project]/app/app/forms/[id]/submissions/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function toDate(ts) {
    ...
    if (ts === null || ts === void 0 ? void 0 : ts.toDate) return ts.toDate();
    if (typeof (ts === null || ts === void 0 ? void 0 : ts.seconds) === "number") return new Date(ts.seconds * 1000);
    return null;
}
...
function SubmissionsPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SubmissionsPage.useEffect": ()=>{
            const unsub = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onAuthStateChanged"])(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["auth"], {
                "SubmissionsPage.useEffect.unsub": (u)=>{
                    if (!u) location.href = "/login";
                    else setUid(u.uid);
                }
            }["SubmissionsPage.useEffect.unsub"]);
            return ({
                "SubmissionsPage.useEffect": ()=>unsub()
            })["SubmissionsPage.useEffect"];
        }
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SubmissionsPage.useEffect": ()=>{
            if (!uid) return;
            ({
                "SubmissionsPage.useEffect": async ()=>{
                    setLoading(true);
                    try {
                        ...
                        const data = f.data();
                        const formSchema = (data === null || data === void 0 ? void 0 : data.schema) || [];
                        setSchema(formSchema);
                        // 2) טען הגשות
                        const q = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["query"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["collection"])(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], "forms", formId, "submissions"), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["orderBy"])("submittedAt", "desc"));
                        ...
                        const arr = snap.docs.map({
                            "SubmissionsPage.useEffect.arr": (d)=>({
                                    id: d.id,
                                    ...d.data()
                                })
                        }["SubmissionsPage.useEffect.arr"]);
                        setItems(arr);
                    } finally{
                        setLoading(false);
                    }
    ...
    const fieldById = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "SubmissionsPage.useMemo[fieldById]": ()=>{
            const map = new Map();
            schema.forEach({
                "SubmissionsPage.useMemo[fieldById]": (f)=>map.set(f.id, f)
            }["SubmissionsPage.useMemo[fieldById]"]);
            return map;
        }
    }["SubmissionsPage.useMemo[fieldById]"], [
    ...
    const filtered = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "SubmissionsPage.useMemo[filtered]": ()=>{
            if (!filter.trim()) return items;
            const f = filter.trim().toLowerCase();
            return items.filter({
                "SubmissionsPage.useMemo[filtered]": (s)=>{
                    const parts = [];
                    const answers = s.answers || {};
                    for (const [fid, val] of Object.entries(answers)){
                        const field = fieldById.get(fid);
                        const label = (field === null || field === void 0 ? void 0 : field.label) || fid;
                        const pretty = prettyValue(field, val);
                        parts.push("".concat(label, ": ").concat(pretty));
                    }
    ...
    function exportCSV() {
        ...
        const csv = header.join(",") + "\n" + rows.map((r)=>r.map((cell)=>{
                const str = String(cell !== null && cell !== void 0 ? cell : "");
        ...
        a.download = "submissions-".concat(formId, "-").concat(stamp, ".csv");
        a.click();
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("a", {
                                href: "/app/forms/".concat(formId, "/edit"),
                                className: "border p-2 rounded",
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            s.signatureUrl ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("a", {
                                                href: s.signatureUrl,
                                                target: "_blank",
                                                className: "underline",
                                                children: "חתימה"
                                    ...
                                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: pv || /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                    className: "text-gray-400",
                                                    children: "—"
                                                }, void 0, false, {
                                                    fileName: "[project]/app/app/forms/[id]/submissions/page.tsx",
...
//# sourceMappingURL=_756364e5._.js.map